...
const router = createBrowserRouter([
    {path:"/SmartDeviceRegistration", element: <UnauthenticatedRoute><VehicleChargerRegistrationForm smartHomeId="8f63caca-96ae-4a13-930a-e935c25e3a03"/></UnauthenticatedRoute>},
