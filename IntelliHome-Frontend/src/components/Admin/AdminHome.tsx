import {Box, Button, Container, Dialog, Grid, TablePagination, Typography} from "@mui/material";
...
import SmartHomeCreatingMap from "../User/SmartHomeCreatingMap.tsx";
import SmartHomeCreatingInfo from "../User/SmartHomeCreatingInfo.tsx";
